...
public class ReturnSlice {
    public static void main(String[] args) {
        ...
        String outputFilePath = "C:\\eclipse-java-2023-12-R-win32-x86_64\\java\\TEXT\\return.txt"; // 输出文件路径
                ...
                if (method != null) {
                    ...
                    if (javadoc != null && hasReturnTag(javadoc)) {
                        try (FileWriter fw = new FileWriter(outputFilePath, true);
                            ...
                            //out.println("Return 语句: " + "return " + returnExpression.toString());
                            out.println("Javadoc @return: " + getReturnDescription(javadoc));
                            out.println();
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
    ...
    private static List<Statement> getRelatedStatements(Expression returnExpression, Block methodBody) {
        ...
        // 按照语句在源代码中的顺序排序 relatedStatements
        relatedStatements.sort(Comparator.comparingInt(statement -> methodBody.statements().indexOf(statement)));
