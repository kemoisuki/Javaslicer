...
def get_filenames(data_root, task, sub_task, split=''):
    if task == 'concode':
        ...
        data_dir = '/root/autodl-tmp/project/CCodeT5/data'
        train_fn = '/root/autodl-tmp/project/CCodeT5/data/train.jsonl'
        dev_fn = '/root/autodl-tmp/project/CCodeT5/data/test.jsonl'
        test_fn = '/root/autodl-tmp/project/CCodeT5/data/test.jsonl'
    elif task == 'refine':
        data_dir = '{}/{}/{}'.format(data_root, task, sub_task)
